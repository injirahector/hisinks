              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+254112146636"
                      className="text-white hover:text-brand-accent transition-colors text-sm block">
                      +254 112 146 636
                    </a>
                    <a href="tel:+254100664414"
                      className="text-white hover:text-brand-accent transition-colors text-sm block mt-0.5">
                      +254 100 664 414
                    </a>
                  </div>
                </div>
